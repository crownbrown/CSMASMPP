...
;				All reading and writing is down using Irving Read/Write String ONLY, not use of Read/Write Dec or Int used. 
;				Reading and writing is down through two macros called throughout the program. 
